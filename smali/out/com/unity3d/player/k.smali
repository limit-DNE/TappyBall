...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput p2, p0, Lcom/unity3d/player/k;->a:I

    invoke-virtual {p0}, Lcom/unity3d/player/k;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    invoke-virtual {p0}, Lcom/unity3d/player/k;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {p0}, Lcom/unity3d/player/k;->forceLayout()V
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, p0, Lcom/unity3d/player/k;->c:Landroid/graphics/Bitmap;
    ...
    iput-object v1, p0, Lcom/unity3d/player/k;->c:Landroid/graphics/Bitmap;
...
.method public final onLayout(ZIIII)V
    ...
    :cond_5
    iget-object p1, p0, Lcom/unity3d/player/k;->c:Landroid/graphics/Bitmap;
    ...
    iput-object p1, p0, Lcom/unity3d/player/k;->c:Landroid/graphics/Bitmap;
    ...
    iget-object p3, p0, Lcom/unity3d/player/k;->c:Landroid/graphics/Bitmap;

    invoke-virtual {p3}, Landroid/graphics/Bitmap;->getHeight()I

    move-result p3

    invoke-virtual {p0}, Lcom/unity3d/player/k;->getWidth()I

    move-result p4

    invoke-virtual {p0}, Lcom/unity3d/player/k;->getHeight()I
    ...
    :goto_46
    sget-object v5, Lcom/unity3d/player/k$1;->a:[I

    iget v6, p0, Lcom/unity3d/player/k;->a:I
    ...
    :cond_56
    iget p1, p0, Lcom/unity3d/player/k;->a:I

    sget p3, Lcom/unity3d/player/k$a;->c:I
    ...
    iget-object p5, p0, Lcom/unity3d/player/k;->c:Landroid/graphics/Bitmap;
    ...
    iput-object p4, p0, Lcom/unity3d/player/k;->d:Landroid/graphics/Bitmap;

    :cond_90
    iget-object p4, p0, Lcom/unity3d/player/k;->c:Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, p4}, Lcom/unity3d/player/k;->setBackground(Landroid/graphics/drawable/Drawable;)V
